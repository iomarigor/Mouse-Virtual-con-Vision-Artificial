...
#anchocam, altocam = 320, 240
cuadro = 150 #Rango donde podemos interactura
...
while True:
    ...
    if len(lista) != 0:
        ...
        if dedos[1]== 1 :  #Si el indice esta arriba pero el corazon esta abajo
        ...
        if dedos[1] == 1 and dedos[2] == 0:  # Si el indice esta arriba y el corazon tambien
            # --------------->Modo click: encontrar la distancia entre ellos-------------------------
            longitud, frame, linea = detector.distancia(4,8,frame) #Nos entrega la distancia entre el punto 8 y 12
            #print(longitud)
            if longitud < 20:
        ...
        if dedos[1] == 1 and dedos[2] == 1:  # Si el indice esta arriba y el corazon tambien
            # --------------->Modo click: encontrar la distancia entre ellos-------------------------
            longitud1, frame1, linea1 = detector.distancia(4,8,frame) #Nos entrega la distancia entre el punto 8 y 12
            #print(longitud)
            if longitud1 < 30:
                cv2.circle(frame1, (linea1[4],linea1[5]), 10, (0,255,0), cv2.FILLED)

                #-------------------- Hacemos click si la distancia es corta ---------------------------
                #autopy.mouse.click(autopy.mouse.Button.RIGHT)
                pyautogui.click(button='right')

        if dedos[0] == 1 and dedos[1] == 1 and dedos[2] == 1 and dedos[3] == 1 and dedos[4] == 1:  # Si el indice esta arriba y el corazon tambien
            pyautogui.scroll(120)

        if dedos[0] == 0 and dedos[1] == 0 and dedos[2] == 0 and dedos[3] == 0 and dedos[4] == 0:  # Si el indice esta arriba y el corazon tambien
            pyautogui.scroll(-120)
